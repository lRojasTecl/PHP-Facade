...
<form action="Bienvenido.php" method="post">
    ...
    FechaDeNacimiento: <input type="text" name="fecha de nacimiento"><br>
    Cedula: <input type="text" name="cedula"><br>
    CedulaPadre: <input type="text" name="cedula padre"><br>
    CedulaMadre: <input type="text" name="cedula madre"><br>
    Sexo: <input type="text" name="sexo"><br>
    Nacionalidad: <input type="text" name="nacionalidad"><br>
    Edad: <input type="text" name="edad"><br>
    Hijos: <input type="text" name="hijos"><br>
    Matrimonios: <input type="text" name="matrimonios"><br>
    LugarDeVotacion: <input type="text" name="lugar de votacion"><br>
    <input type="submit">
</form>
